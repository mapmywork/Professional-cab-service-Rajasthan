...
export const FLEET = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1503376712341-a1e48ebccfcd?q=80&w=800',
    premium: false
  },
  {
    id: 'ertiga',
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1621007947382-bb3c3994e3fd?q=80&w=800',
    premium: false
  },
  {
    id: 'punch',
...
export const TESTIMONIALS = [
  {
    ...
    name: 'Rajiv Malhotra',
    rating: 5,
    text: 'Rented the Mercedes S-Class for a corporate event. The car was pristine, and the entire process was remarkably smooth and professional. Truly a premium experience.',
  },
  {
    id: 2,
    name: 'Vikram Singh',
    rating: 5,
    text: 'Took the Thar RWD for a weekend trip to the hills. Chinnu Car Rentals provided a brand new vehicle. Outstanding service and transparent pricing!',
  },
  {
    id: 3,
    name: 'Neha Sharma',
    rating: 5,
    text: 'The best self-drive service in Gurgaon. I rent from them monthly, and their fleet is always well-maintained. Highly recommend the XUV700.',
  }
];

export const CONTACT_INFO = {
  name: 'Chinnu Car Rentals',
  tagline: 'Premium Self Drive Cars In Gurgaon',
  phones: ['+91 8168255802'],
  cleanPhones: ['+918168255802'],
  email: 'Support@chinnucarrentals.com',
  address: 'Plot No. 148, Ground Floor, Gali No. 3, Satguru Enclave Road, Udyog Vihar, Sector 18, Gurugram, Haryana – 122017, India',
};
