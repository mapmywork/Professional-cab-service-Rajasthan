...
// Real car image mapping using Unsplash - consistent professional shots
const CAR_IMAGES = {
  's-class': 'https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?q=80&w=900&auto=format&fit=crop',
  'fortuner': 'https://images.unsplash.com/photo-1556189250-72ba954cfc2b?q=80&w=900&auto=format&fit=crop',
  'xuv700': 'https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?q=80&w=900&auto=format&fit=crop',
  'scorpio-n': 'https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?q=80&w=900&auto=format&fit=crop',
  'thar-roxx': 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?q=80&w=900&auto=format&fit=crop',
  'thar-rwd': 'https://images.unsplash.com/photo-1559416523-140ddc3d238c?q=80&w=900&auto=format&fit=crop',
  'scorpio-s11': 'https://images.unsplash.com/photo-1506015391300-4802dc74de3b?q=80&w=900&auto=format&fit=crop',
  'ertiga': 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?q=80&w=900&auto=format&fit=crop',
  'fronx': 'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?q=80&w=900&auto=format&fit=crop',
  'taisor': 'https://images.unsplash.com/photo-1621007947382-bb3c3994e3fd?q=80&w=900&auto=format&fit=crop',
  'punch': 'https://images.unsplash.com/photo-1542362567-b07e54358753?q=80&w=900&auto=format&fit=crop',
  'swift': 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=900&auto=format&fit=crop',
};
  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 sm:h-64 overflow-hidden bg-charcoal">
        <img
          src={CAR_IMAGES[vehicle.id] || vehicle.image}
          alt={vehicle.name}
