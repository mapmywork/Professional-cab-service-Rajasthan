...
import { Menu, X, Phone, MessageSquare, CarFront } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <a href="#home" onClick={(e) => handleScrollTo(e, '#home')} className="flex items-center group space-x-2">
            <div className="bg-primary text-secondary p-2 rounded-xl shadow-lg border border-silver/20 group-hover:bg-accent transition-colors duration-300">
              <CarFront className="w-6 h-6" />
            </div>
            <div className="flex flex-col">
              <span className={`text-xl font-bold tracking-tight ${scrolled ? 'text-primary' : 'text-white'} group-hover:text-accent transition-colors duration-300`}>CHINNU</span>
              <span className={`text-[10px] uppercase font-semibold tracking-widest ${scrolled ? 'text-charcoal' : 'text-silver-light'}`}>Car Rentals</span>
            </div>
          </a>
