...
import { Phone, Mail, MapPin, ArrowRight, ShieldCheck, Heart, CarFront } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2">
              <div className="bg-secondary text-primary p-2 rounded-xl shadow-lg border border-silver/20">
                <CarFront className="w-6 h-6" />
              </div>
              <div className="flex flex-col">
                <span className="text-xl font-bold tracking-tight text-secondary">CHINNU</span>
                <span className="text-[10px] uppercase font-semibold tracking-widest text-silver">Car Rentals</span>
              </div>
            </div>
